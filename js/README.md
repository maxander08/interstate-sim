...
- **CONUS** — the entire US Interstate System, **all 50 states**: Hawaii (H-1/2/3, H-201) and Alaska's
  unsigned interstate corridors (A-1…A-4, OpenStreetMap geometry, AASHTO corridor mapping) ship as
  classic Albers-USA **scaled insets** in the lower-left — same detail, same layers, fully simulated
...
|---|---|---|
| US-50 (229 routes, 15.7k nodes) | US Census **TIGER 2024 Primary Roads** (`RTTYP = I`) + **OpenStreetMap** AK corridors | US/State/named arterials (`RTTYP U/S/M` — 11.5k polylines) + OSM AK trunk/primary · **Census cb 5m state boundaries** · county/borough 500k mesh (3.8k rings) · NE **cities (554, 5 population tiers)** · NE lakes & rivers |
